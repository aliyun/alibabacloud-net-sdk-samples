...
#### How to Run
- *Requires .NET Framework 4.7.2 or .NET Core 2.0 or later. It is recommended to use the newest version of .NET*
```sh
cd ./core && dotnet run
```

#### More Samples
For additional examples, visit: https://github.com/aliyun/alibabacloud-net-sdk-samples