...
namespace AlibabaCloud.CodeSample
{
    public class Sample 
    {
        ...
        public static async Task<PurchaseRatePlanResponseBody> RatePlanInstCaaAsync(ESA20240910Client client)
        {
        ...
        public static async Task<CreateSiteResponseBody> SiteCaaAsync(PurchaseRatePlanResponseBody ratePlanInstCaaResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task<CreateRecordResponseBody> RecordAsync(CreateSiteResponseBody siteCaaResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task Main(string[] args)
        {
            ...
            // Init resource
            PurchaseRatePlanResponseBody ratePlanInstCaaRespBody = await RatePlanInstCaaAsync(esa20240910Client);
            CreateSiteResponseBody siteCaaRespBody = await SiteCaaAsync(ratePlanInstCaaRespBody, esa20240910Client);
            CreateRecordResponseBody recordRespBody = await RecordAsync(siteCaaRespBody, esa20240910Client);
            // update resource
