...
namespace AlibabaCloud.CodeSample
{
    public class Sample 
    {
        ...
        public static async Task<PurchaseRatePlanResponseBody> RatePlanInstSshfpAsync(ESA20240910Client client)
        {
        ...
        public static async Task<CreateSiteResponseBody> SiteSshfpAsync(PurchaseRatePlanResponseBody ratePlanInstSshfpResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task<CreateRecordResponseBody> RecordSshfpAsync(CreateSiteResponseBody siteSshfpResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task UpdateRecordSshfpAsync(CreateRecordResponseBody createRecordResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task DestroyRecordSshfpAsync(CreateRecordResponseBody createRecordResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task Main(string[] args)
        {
            ...
            // Init resource
            PurchaseRatePlanResponseBody ratePlanInstSshfpRespBody = await RatePlanInstSshfpAsync(esa20240910Client);
            CreateSiteResponseBody siteSshfpRespBody = await SiteSshfpAsync(ratePlanInstSshfpRespBody, esa20240910Client);
            CreateRecordResponseBody recordSshfpRespBody = await RecordSshfpAsync(siteSshfpRespBody, esa20240910Client);
            // update resource
            await UpdateRecordSshfpAsync(recordSshfpRespBody, esa20240910Client);
            // destroy resource
            await DestroyRecordSshfpAsync(recordSshfpRespBody, esa20240910Client);
        }
