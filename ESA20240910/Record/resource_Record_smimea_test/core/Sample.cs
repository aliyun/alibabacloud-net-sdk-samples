...
namespace AlibabaCloud.CodeSample
{
    public class Sample 
    {
        ...
        public static async Task<PurchaseRatePlanResponseBody> RatePlanInstSmimeaAsync(ESA20240910Client client)
        {
        ...
        public static async Task<CreateSiteResponseBody> SiteSmimeaAsync(PurchaseRatePlanResponseBody ratePlanInstSmimeaResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task<CreateRecordResponseBody> RecordSmimeaAsync(CreateSiteResponseBody siteSmimeaResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task UpdateRecordSmimeaAsync(CreateRecordResponseBody createRecordResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task DestroyRecordSmimeaAsync(CreateRecordResponseBody createRecordResponseBody, ESA20240910Client client)
        {
        ...
        public static async Task Main(string[] args)
        {
            ...
            // Init resource
            PurchaseRatePlanResponseBody ratePlanInstSmimeaRespBody = await RatePlanInstSmimeaAsync(esa20240910Client);
            CreateSiteResponseBody siteSmimeaRespBody = await SiteSmimeaAsync(ratePlanInstSmimeaRespBody, esa20240910Client);
            CreateRecordResponseBody recordSmimeaRespBody = await RecordSmimeaAsync(siteSmimeaRespBody, esa20240910Client);
            // update resource
            await UpdateRecordSmimeaAsync(recordSmimeaRespBody, esa20240910Client);
            // destroy resource
            await DestroyRecordSmimeaAsync(recordSmimeaRespBody, esa20240910Client);
        }
